...
class Pedidos
{
     ...
     * @var float
     *
     * @ORM\Column(name="montototalpedido", type="float", precision=10, scale=0, nullable=false)
     */
    private $montototalpedido;

     /**
     * @var float
     *
     * @ORM\Column(name="montototalpago", type="float", precision=10, scale=0, nullable=false)
     */
    private $montototalpago;

     /**
     * @var float
     *
     * @ORM\Column(name="por_pagar", type="float", precision=10, scale=0, nullable=false)
     */
    private $porPagar;
     ...
     *
     * @param string $montototalpedido
     *
     * @return Pedidos
     */
    public function setMontototalpedido(\GestionBundle\Entity\StatusEntrega $statusPedido = null)
    {
     ...
     * @param string $montototalpedido
     */
    public function getMontototalpedido()
    {
     ...
     * Set montototalpago.
     *
     * @param string $montototalpago
     *
     * @return Pedidos
     */
    public function setMontototalpago(\GestionBundle\Entity\StatusEntrega $montototalpago = null)
    {
     ...
     * @param string $montototalpago
     */
    public function getMontototalpago()
    {
        return $this->montototalpago;
    }
     /**
     * Set porPagar.
     *
     * @param string $porPagar
     *
     * @return Pedidos
     */
    public function setPorPagar(\GestionBundle\Entity\StatusEntrega $porPagar = null)
    {
